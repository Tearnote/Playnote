...
static void render_select(gfx::Renderer::Queue& queue, GameState& state)
{
	...
	// Non-grouped outline+glow
	queue.line({
		.position = {80.0f, 430.0f},
		.color = {1.0f, 1.0f, 1.0f, 1.0f},
		.depth = 5,
		.outline_width = 2.0f,
		.outline_color = {0.2f, 0.2f, 1.0f, 1.0f},
		.glow_width = 8.0f,
		.glow_color = {1.0, 1.0, 0.2f, 1.0f},
	}, {
		.end = {100.0f, 10.0f},
		.width = 8.0f,
		.cap = gfx::Renderer::LineParams::Cap::Round,
	...
	// Grouped outline+glow
	queue.group([&] {
		queue.line({
			.position = {80.0f, 450.0f},
			.color = {1.0f, 1.0f, 1.0f, 1.0f},
			.depth = 5,
			.outline_width = 2.0f,
			.outline_color = {0.2f, 0.2f, 1.0f, 1.0f},
