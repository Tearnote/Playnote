...
inline void run_input(Broadcaster& broadcaster, dev::Window& window, fs::path const& song_request)
{
...
inline void input(Broadcaster& broadcaster, Barriers<3>& barriers, dev::Window& window, fs::path const& song_request)
try {
